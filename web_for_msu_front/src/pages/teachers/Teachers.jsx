...
const Teachers = () => {
  ...
  const [teachers, setTeachers] = useState({
    ...
    'organizers': [
      {id: 0, name: 'Ivanov Ivan Ivanovich', phone: '34234234234', what: ['Летняя Школа, Вступы']},
      {id: 0, name: 'Ivanov Ivan Ivanovich', phone: '34234234234', what: ['Летняя Школа, Вступы']},
      {id: 0, name: 'Ivanov Ivan Ivanovich', phone: '34234234234', what: ['Летняя Школа, Вступы']},
    ],
  });
  ...
  return (
    <article>
      ...
      <section>
        <p>Адрес: Москва, Воробьевы горы, III Гуманитарный корпус МГУ имени М.В.Ломоносова, Экономический факультет, комната 364, ЭМШ</p>
        ...
        <ul>
          ...
          <li><p>Ответственный за сувенирную продукцию - <a href='mailto:souvenir@emsch.ru'>souvenir@emsch.ru</a></p></li>
