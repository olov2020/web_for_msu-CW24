    ...
    <article>
      ...
      <section className={styleEvents.section}>
        <p>В 2021-22 учебном году Экономико-математическая школа при поддержке экономического факультета МГУ имени М.В.
          Ломоносова проводит Открытый чемпионат школ по экономике (ОЧ) для школьников 7-11 классов. Чемпионат состоится
        ...
        <p>Победители Чемпионата зачисляются в ЭМШ без экзаменов.</p>
